      ...
      <section id="top" className="relative min-h-screen flex items-center pt-20 pb-8 md:pt-24 md:pb-12 noise overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 grid lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full relative z-10">
          <div className="lg:col-span-7 animate-float-up text-center lg:text-left">
            <div className="flex items-center gap-3 mb-8 md:mb-8 text-xs uppercase tracking-[0.3em] text-muted-foreground justify-center lg:justify-start">
              <span className="w-8 h-px bg-primary animate-shimmer" />
              Available for opportunities
            </div>
            <h1 className="font-display text-[clamp(3rem,10vw,8rem)] leading-[1.1] tracking-tight">
              Sheraz <span className="italic text-gradient-gold">Dilbar</span>
            </h1>
            <p className="mt-8 md:mt-8 max-w-xl mx-auto lg:mx-0 text-base md:text-lg text-muted-foreground leading-relaxed">
            ...
            <div className="mt-10 md:mt-10 flex flex-wrap items-center gap-4 md:gap-6 justify-center lg:justify-start">
              <a href="#work"
            ...
            <div className="mt-14 md:mt-16 grid grid-cols-3 gap-6 md:gap-8 max-w-md mx-auto lg:mx-0">
              <div>
